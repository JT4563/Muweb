...
describe('JWT Service Tests', () => {
  ...
  describe('Token Generation', () => {
    ...
    it('should have correct expiration for access token (15m)', () => {
      ...
      expect(expiration.getTime()).toBeGreaterThan(now.getTime() + 14 * 60 * 1000);
    ...
    it('should have correct expiration for refresh token (7 days)', () => {
      ...
      expect(expiration.getTime()).toBeGreaterThan(now.getTime() + sevenDaysInMs - 3600000);
      expect(expiration.getTime()).toBeLessThan(now.getTime() + sevenDaysInMs + 3600000);
    });
  });
